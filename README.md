...
Historically Jahia has been distributing its codebase under a dual licensing model, GPLv3 and our own JSEL (Enterprise) license. As the software (and the open-source) industry evolves, we are taking steps towards modernizing our practices. 
...
Watch for the license file in each our repository to better understand which license currently apply to the codebase.
